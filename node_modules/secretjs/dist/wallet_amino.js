...
exports.isDirectSigner = exports.serializeStdSignDoc = exports.sortObject = exports.encodeSecp256k1Pubkey = exports.encodeSecp256k1Signature = exports.base64PubkeyToAddress = exports.pubkeyToAddress = exports.AminoWallet = exports.SECRET_BECH32_PREFIX = exports.SECRET_COIN_TYPE = void 0;
...
function base64PubkeyToAddress(pubkey, prefix = "secret") {
    return bech32_1.bech32.encode(prefix, bech32_1.bech32.toWords((0, ripemd160_1.ripemd160)((0, sha256_1.sha256)((0, encoding_1.fromBase64)(pubkey)))));
}
