...
class MetaMaskWallet {
    constructor(ethProvider, ethAddress, publicKey) {
        ...
        this.address = (0, wallet_amino_1.pubkeyToAddress)(this.publicKey);
    }
    ...
    getSignMode() {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield Promise.resolve().then(() => __importStar(require("./protobuf_stuff/cosmos/tx/signing/v1beta1/signing"))))
