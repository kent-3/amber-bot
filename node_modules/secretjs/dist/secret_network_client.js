...
class SecretNetworkClient {
    ...
    decodeTxResponses(txResponses) {
        return __awaiter(this, void 0, void 0, function* () {
            let nonces = [];
            return yield Promise.all(txResponses.map((txResp) => __awaiter(this, void 0, void 0, function* () {
                // Decode input tx
                const decodedTx = (yield Promise.resolve().then(() => __importStar(require("./protobuf_stuff/cosmos/tx/v1beta1/tx")))).Tx.decode(txResp.tx.value);
                ...
                const txMsgData = TxMsgData.decode((0, encoding_1.fromHex)(txResp.data));
                    ...
                    if (nonce && nonce.length === 32) {
                        ...
                        try {
                            ...
                            if (typeUrl === "/secret.compute.v1beta1.MsgInstantiateContract") {
                                const decoded = (yield Promise.resolve().then(() => __importStar(require("./protobuf_stuff/secret/compute/v1beta1/msg")))).MsgInstantiateContractResponse.decode(txMsgData.data[msgIndex].data);
                                const decrypted = (0, encoding_1.fromBase64)((0, encoding_1.fromUtf8)(yield this.encryptionUtils.decrypt(decoded.data, nonce)));
                                data[msgIndex] = (yield Promise.resolve().then(() => __importStar(require("./protobuf_stuff/secret/compute/v1beta1/msg")))).MsgInstantiateContractResponse.encode({
                                    address: decoded.address,
                                    data: decrypted,
                                }).finish();
                            }
                            else if (typeUrl === "/secret.compute.v1beta1.MsgExecuteContract") {
                                const decoded = (yield Promise.resolve().then(() => __importStar(require("./protobuf_stuff/secret/compute/v1beta1/msg")))).MsgExecuteContractResponse.decode(txMsgData.data[msgIndex].data);
                                const decrypted = (0, encoding_1.fromBase64)((0, encoding_1.fromUtf8)(yield this.encryptionUtils.decrypt(decoded.data, nonce)));
                                data[msgIndex] = (yield Promise.resolve().then(() => __importStar(require("./protobuf_stuff/secret/compute/v1beta1/msg")))).MsgExecuteContractResponse.encode({
                                    data: decrypted,
                                }).finish();
                            }
                        }
     ...
     */
    broadcastTx(tx, timeoutMs, checkIntervalMs, mode, waitForCommit) {
        return __awaiter(this, void 0, void 0, function* () {
            const start = Date.now();
            const txhash = (0, encoding_1.toHex)((0, sha256_1.sha256)(tx)).toUpperCase();
            ...
            if (mode === BroadcastMode.Block) {
                ...
                try {
                    ({ txResponse } = yield this.txService.broadcastTx({
                        txBytes: tx,
                        mode: BroadcastMode.BROADCAST_MODE_BLOCK,
                    }));
                }
                catch (e) {
                    if (JSON.stringify(e).includes("timed out waiting for tx to be included in a block")) {
                ...
                if (!isBroadcastTimedOut) {
                    ...
                    return (yield this.decodeTxResponses([txResponse]))[0];
                }
            }
                ...
                if ((txResponse === null || txResponse === void 0 ? void 0 : txResponse.code) !== 0) {
    ...
    signAmino(account, messages, fee, memo, { accountNumber, sequence, chainId }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let signMode = (yield Promise.resolve().then(() => __importStar(require("./protobuf_stuff/cosmos/tx/signing/v1beta1/signing")))).SignMode.SIGN_MODE_LEGACY_AMINO_JSON;
            ...
            return (yield Promise.resolve().then(() => __importStar(require("./protobuf_stuff/cosmos/tx/v1beta1/tx")))).TxRaw.fromPartial({
